...
namespace AssetRegister
{
    public partial class IT : System.Web.UI.Page
    {
        ...
        protected void reloadAssets(object sender, EventArgs e)
        {
            ...
            IList<ITAsset> assets = ass.getAssets(trkId, devId, osId, manId, deptId, showInactive);
        ...
        private IList<ITAssetExport> getAssetsForExport()
        {
            // Check the show inactive box to see if its active or inactive assets to display
            int showInactive = 0;
            if (chkShowInactive.Checked)
            ...
            IList<ITAssetExport> assets = ass.getAssetsForExport(trkId, devId, osId, manId, deptId, showInactive);
            return assets;            
        }
        #endregion
        ...
        protected void grdAssets_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Edit")
            {
                ...
                Response.Redirect("ITAssetInfo.aspx?assetId=" + idtAsset);
            }
        }
        ...
        protected void btnSearchDescription_Click(object sender, EventArgs e)
        {
            ...
            if (tbSearchDescription.Text.Length > 0)
            {
                ddl_DataBind();
                ITAsset ass = new ITAsset();
                IList<ITAsset> assets = ass.getAssets(tbSearchDescription.Text, "", "");
        ...
        protected void btnSearchHostName_Click(object sender, EventArgs e)
        {
            ...
            if (tbSearchHostName.Text.Length > 0)
            {
                ddl_DataBind();
                ITAsset ass = new ITAsset();
                IList<ITAsset> assets = ass.getAssets("", tbSearchHostName.Text, "");
        ...
        protected void btnSearchIp_Click(object sender, EventArgs e)
        {
            ...
            if (tbSearchIp.Text.Length > 0)
            {
                ddl_DataBind();
                ITAsset ass = new ITAsset();
                IList<ITAsset> assets = ass.getAssets("", "", tbSearchIp.Text);
        ...
        {
            Response.Redirect("ITAssetInfo.aspx"); // Redirect to AssetInfo Page without passing in the Asset ID will show that its a new Asset
        }
        ...
        protected void ExportToExcel(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", "attachment;filename=IT_Assets " + DateTime.Now.ToString("ddMMMyyyy") + ".xls");
            Response.Charset = "";
